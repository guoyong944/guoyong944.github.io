...
function display_rule(){
    ...
    document.getElementById("next_rule").style.shadow = "0px 2px 6px 0px rgba(199, 199, 199, 0.1);";
    document.getElementById("previous_rule").style.background = "#FFFFFF";
    document.getElementById("previous_rule").style.shadow = "0px 2px 6px 0px rgba(199, 199, 199, 0.1);";
...
function submit_step(direction){
    if(direction == "next"){
        ...
        document.getElementById("next_rule").style.shadow = "0px 2px 6px 0px rgba(100, 100, 100, 0.3)";
